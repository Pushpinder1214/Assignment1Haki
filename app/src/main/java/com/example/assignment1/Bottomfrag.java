 ...
 * Use the {@link Bottomfrag#newInstance} factory method to
...
public class Bottomfrag extends Fragment {
    ...
    public static Bottomfrag newInstance(String param1, String param2) {
        Bottomfrag fragment = new Bottomfrag();
